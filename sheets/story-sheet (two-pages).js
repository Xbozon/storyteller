...
export class StorySheet2Pages extends DocumentSheet {
    pageFlip = "modules/storyteller/sounds/paper-flip.mp3"

    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            baseApplication: 'JournalSheet',
            classes: ["sheet", "story-sheet-pages", game.settings.get('storyteller', 'theme')],
            template: 'modules/storyteller/templates/story-sheet (two-pages).html',
            width: getBookWidth(),
    ...
    _onConfigureStory(event) {
        let story = $(event.target).closest(".window-app.story-sheet-pages")
