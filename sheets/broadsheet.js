...
const bookWidth = 1000 //937
const bookHeight = 1300 //1390

export class BroadsheetSheet extends DocumentSheet {
    pageFlip = "modules/storyteller/sounds/paper-flip.mp3"

    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            baseApplication: 'JournalSheet',
            classes: ["sheet", "story-sheet", "broadsheet"],
            template: 'modules/storyteller/templates/broadsheet.html',
            width: getBookWidth(),
